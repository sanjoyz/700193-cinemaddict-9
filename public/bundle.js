...
class MenuController {
  ...
  init() {
    ...
    searchInputElement.addEventListener(`keyup`, lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default()((evt) => {
...
class StatisticsController {
  ...
  _renderCharts(cards) {
    ...
    return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(chartCtx, {
  ...
  _onFilterInputChange(evt, cards) {
    switch (evt.target.dataset.filter) {
      case `all`:
        ...
        break;
      case `today`:
        this._renderStatistics(cards.slice().filter(_utils_constants__WEBPACK_IMPORTED_MODULE_5__["Filters"].TODAY.METHOD));
        this._renderCharts(cards.slice().filter(_utils_constants__WEBPACK_IMPORTED_MODULE_5__["Filters"].TODAY.METHOD));
        break;
      case `week`:
        this._renderStatistics(cards.slice().filter(_utils_constants__WEBPACK_IMPORTED_MODULE_5__["Filters"].WEEK.METHOD));
        this._renderCharts(cards.slice().filter(_utils_constants__WEBPACK_IMPORTED_MODULE_5__["Filters"].WEEK.METHOD));
        break;
      case `month`:
        this._renderStatistics(cards.slice().filter(_utils_constants__WEBPACK_IMPORTED_MODULE_5__["Filters"].MONTH.METHOD));
        this._renderCharts(cards.slice().filter(_utils_constants__WEBPACK_IMPORTED_MODULE_5__["Filters"].MONTH.METHOD));
        break;
      case `year`:
        this._renderStatistics(cards.slice().filter(_utils_constants__WEBPACK_IMPORTED_MODULE_5__["Filters"].YEAR.METHOD));
        this._renderCharts(cards.slice().filter(_utils_constants__WEBPACK_IMPORTED_MODULE_5__["Filters"].YEAR.METHOD));
        break;
    }
  }
}
